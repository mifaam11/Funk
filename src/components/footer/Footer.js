  ...
  return (
    <footer className="bg-[#1F2B31] text-white py-10 px-10">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 w-[90%]">
        ...
        {/* Navigation */}
        <div>
          <h2 className="font-bold mb-4">For Renters</h2>
          <ul>
            <li><a href="#" className="hover:text-gray-400">About Us</a></li>
            <li><a href="#" className="hover:text-gray-400">How it works</a></li>
            <li><a href="#" className="hover:text-gray-400">Our fleet</a></li>
        ...
        <div>
          ...
          <ul>
            <li><a href="#" className="hover:text-gray-400">Media & Blog</a></li>
            ...
            <li><a href="#" className="hover:text-gray-400">Legal information</a></li>
